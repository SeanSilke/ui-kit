...
class ThemesPage extends React.Component {
      ...
      <ClearFix>
        ...
        <div style={styles.group}>
          ...
          <div style={styles.container}>
            ...
            <Toggle name="toggleName2" label="disabled toggle" defaultToggled disabled />
          </div>
        </div>
        <div style={Object.assign({}, styles.group, { marginTop: 0 })}>
          ...
          <div style={styles.container}>
            <DatePicker hintText="Landscape Dialog" mode="landscape" style={{ width: '100%' }} />
          </div>
          <div style={styles.container}>
        ...
        <div style={styles.group}>
          <div style={styles.containerCentered}>
            <FlatButton label="Dialog" onTouchTap={this.handleTouchTapDialog} />
            <Dialog
              ...
              actions={[
                <FlatButton
                  ...
                  primary
                />,
                <FlatButton key="Submit" label="Submit" onTouchTap={this.handleRequestCloseDialog} primary />
              ]}
        ...
        <div style={styles.group}>
          <div style={styles.containerCentered}>
            <FlatButton onTouchTap={this.handleTouchTapDrawer} label="Drawer" />
            <Drawer open={this.state.drawerOpen} docked={false} onRequestChange={this.handleRequestChangeDrawer}>
        ...
        <div style={styles.group}>
          <div style={styles.containerCentered}>
            <FlatButton onTouchTap={this.handleTouchTapSnackbar} label="Snackbar" />
          </div>
          <Snackbar
  ...
  getThemeExamples() {
    return (
      <div>
        <Tabs value={this.state.valueTabs} onChange={this.onChange}>
          <Tab label="The Left Tab" value="light" />
          <Tab label="The Right Tab" value="dark" />
        </Tabs>
